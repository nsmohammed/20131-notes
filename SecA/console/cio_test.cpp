#define _IOL_PROGRAM_TITLE "OOP344 20131 CIO tester R 0.94.1"
...
/*
   ...
   Feb 1, 2013
   Version 0.94.1 (Student version)
...
int main(int argc, char* argv[]){
  ...
  do{
    ...
    if(num == 6){
      console<<"Well done!";
      console.setPos(11, 5);
      console<<"You passed all the tests. You can now submit your assignment as follows:";
      console.setPos(13, 5);
	    console<<"Copy your console.cpp and console.h to matrix, and then compile it with";
      console.setPos(14, 5);
	    console<<"Fardad's cio_test.o instead of cio_test.cpp and run it.";
      console.setPos(16, 5);
	    console<<"You can get cio_test.o with following command on your matrix account:";
      console.setPos(18, 5);
	    console<<"$ cp ~fardad.soleimanloo/cio_test.o . <ENTER>";
      done = 1;
    }
    else{
...
int test5(){
  ...
  do{
    ...
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 5: console.edit() General Test, Test console.edit anyway you can and make sure it does not crash.  "
